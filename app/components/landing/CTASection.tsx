...
export function CTASection({ onShowDemo }: CTASectionProps) {
  ...
  return (
    <section className="relative py-8 sm:py-12 px-3 sm:px-4 md:px-6 lg:px-8 bg-gradient-to-br from-hero-bg-start via-hero-bg-mid to-hero-bg-end overflow-hidden">
      {/* Animated background */}
